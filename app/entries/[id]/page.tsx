  ...
  return (
    <div className="w-full max-w-4xl">
      ...
      <article className="bg-parchment-light dark:bg-navy-900 p-8 rounded-lg shadow-md border border-brown-300 dark:border-blue-800">
        <h1 className="text-3xl font-eb-garamond mb-2 text-brown-800 dark:text-blue-100">{entry.title}</h1>
        <p className="text-sm font-special-elite text-brown-600 dark:text-blue-300 mb-6">{entry.date}</p>
